...
export class AdvancesService {
  ...
  async create(supplierId: string, payload: CreateAdvanceDto, userId?: string) {
    ...
    await this.auditService.log('advance.created', 'SupplierAdvance', saved.id, payload as any, userId);
    return saved;
  }
  ...
  async remove(id: string, userId?: string) {
    ...
    await this.auditService.log('advance.deleted', 'SupplierAdvance', id, undefined, userId);
    return { success: true };
  }
}
