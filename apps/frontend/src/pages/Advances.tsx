...
const advances = [
  { supplier: 'Sarl Zeralda Primeurs', date: '2024-02-01', reference: 'ADV-001', amount: 50000 },
  { supplier: 'Ferhani Import', date: '2024-02-04', reference: 'ADV-002', amount: 30000 }
];
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {advances.map((advance) => (
                <tr key={advance.reference} className="border-t border-slate-200">
                  ...
                  <td className="px-4 py-3 font-semibold text-emerald-700">
                    {new Intl.NumberFormat('fr-DZ', { style: 'currency', currency: 'DZD' }).format(advance.amount)}
                  </td>
                </tr>
              ))}
            </tbody>
